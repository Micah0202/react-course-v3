...
const ProductsContainer = () => {
  ...
  const setActiveStyles = (pattern)=>{
     //the styles before the dollar are alwyas applied regardless od whether its  active or not 
      return `text-xl btn btn-circle btn-sm ${pattern===layout ? 'btn-primary text-primary-content':'btn-ghost text-based-content'}`; //styles that will be applied to the active button ? 
